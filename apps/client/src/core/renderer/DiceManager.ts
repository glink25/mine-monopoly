...
// 确保你的开发环境支持此导入，或者从 'three-stdlib' 导入
...
export class DiceManager {
	...
	private _createDiceFaceTexture(value: number | string, baseColor: string): THREE.MeshStandardMaterial {
		...
		ctx.font = 'bold 260px "Comic Sans MS", "Chalkboard SE", sans-serif';
		ctx.textAlign = "center";
		ctx.textBaseline = "middle";
		ctx.fillText(String(value), 0, 20);
